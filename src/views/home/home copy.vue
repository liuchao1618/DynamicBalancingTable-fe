...
import commonJS from '../../assets/js/index.js'
// import sunyue from '../../assets/js/BluetoothTool.js'
export default {
  name: 'home',
  components: {
    login
  ...
  methods: {
    ...
    listenerDeviceFound(){
        plus.bluetooth.onBluetoothDeviceFound(function(e){
            ...
            alert('device found: '+e.length)
            for(var i in devices){
                alert(i+': '+JSON.stringify(devices[i]))
            }
        });
    },
    // 连接低功耗蓝牙设备
    createConnection(){
        ...
        plus.bluetooth.createBLEConnection({
            deviceId:deviceId,
            success:function(e){
                alert('create connection success: '+JSON.stringify(e));
            },
            fail:function(e){
                alert('create connection failed: '+JSON.stringify(e));
            }
        })
    }
  }
