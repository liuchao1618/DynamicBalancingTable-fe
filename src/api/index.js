...
export function login(params) {
  return request({
    url: 'http://39.100.84.219:9001/api/login',
    method: 'POST',
    data: params
  })
}
...
export function phoneList(data) {
  return request({
    url: 'http://39.100.84.219:9001/api/device/cache',
    method: 'GET',
    params: data
  })
}
...
export function editPass(params) {
  return request({
    url: 'http://39.100.84.219:9001/api/user/password',
    method: 'PUT',
    data: params
  })
}
...
export function loginMsg(data) {
  return request({
    url: 'http://39.100.84.219:9001/api/user/myself',
    method: 'GET',
    params: data
  })
}
...
export function exitLogin(data) {
  return request({
    url: 'http://39.100.84.219:9001/api/logout',
    method: 'GET',
    params: data
  })
}
...
export function memberExercise(data) {
  return request({
    url: 'http://39.100.84.219:9001/api/record/relevant',
    method: 'GET',
    params: data
  })
}
...
export function saveRecord(params) {
  return request({
    url: 'http://39.100.84.219:9001/api/record/main',
    method: 'POST',
    data: params
  })
}
...
export function checkMember() {
  return request({
    url: 'http://39.100.84.219:9001/api/member/topClass',
    method: 'GET'
  })
}
//在新记录上添加运动员信息
export function addSport(params) {
  return request({
    url: 'http://39.100.84.219:9001/api/record/member',
    method: 'POST',
    data: params
  })
}
...
export function addCollect(params) {
  return request({
    url: 'http://39.100.84.219:9001/api/record/favorite',
    method: 'POST',
    data: params
  })
}
...
export function memberMessage(data) {
  return request({
    url: 'http://39.100.84.219:9001/api/member/members',
    method: 'GET',
    params: data
  })
}
...
export function trainersName(data) {
  return request({
    url: 'http://39.100.84.219:9001/api/member/trainers',
    method: 'GET',
    params: data
  })
}
...
export function runnersName(data) {
  return request({
    url: 'http://39.100.84.219:9001/api/member/runners',
    method: 'GET',
    params: data
  })
}
...
export function addMember(params) {
  return request({
    url: 'http://39.100.84.219:9001/api/member',
    method: 'POST',
    data: params
  })
}
...
export function trainDetail(data) {
  return request({
    url: 'http://39.100.84.219:9001/api/record',
    method: 'GET',
    params: data
  })
}